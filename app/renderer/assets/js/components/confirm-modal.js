      ...
      <div id="modal-confirm-delete" class="modal-overlay">
        <div class="modal-container" style="max-width: 400px;">
          <div class="modal-body text-center py-8">
            <!-- Warning Icon -->
            <div class="w-16 h-16 mx-auto mb-4 bg-red-100 flex items-center justify-center">
            ...
            <div id="confirm-modal-preview" class="hidden bg-gray-50 border border-gray-200 p-3 mb-6 text-left">
            ...
            <div class="flex gap-3 justify-center">
              <button id="btn-confirm-cancel" class="px-5 py-2.5 bg-white border border-gray-200 text-gray-700 font-medium text-sm hover:bg-gray-50 transition-colors">
                Cancel
              </button>
              <button id="btn-confirm-delete" class="px-5 py-2.5 bg-red-600 text-white font-medium text-sm hover:bg-red-700 transition-colors">
                Delete
              </button>
            </div>
          </div>
  ...
  show(options) {
    ...
    if (confirmBtn) {
      ...
      if (options.confirmClass) {
        confirmBtn.className = `px-5 py-2.5 font-medium text-sm transition-colors ${options.confirmClass}`;
      } else {
        confirmBtn.className = 'px-5 py-2.5 bg-red-600 text-white font-medium text-sm hover:bg-red-700 transition-colors';
      }
    }
